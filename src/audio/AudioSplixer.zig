...
pub inline fn getLeft(self: *const AudioSplixer) []const f32 {
    return self.left;
}

pub inline fn getRight(self: *const AudioSplixer) []const f32 {
    return self.right;
}

pub inline fn getCenter(self: *const AudioSplixer) []const f32 {
    return self.center;
}
