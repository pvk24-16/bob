...
pub fn Window(comptime callbacks: usize) type {
    return struct {
        const Self = @This();
        ...
        resize_callbacks: [callbacks]*const fn (i32, i32, ?*anyopaque) void = undefined,
        key_callbacks: [callbacks]*const fn (i32, i32, i32, i32, ?*anyopaque) void = undefined,
        mouse_callbacks: [callbacks]*const fn (i32, i32, i32, ?*anyopaque) void = undefined,
        cursor_callbacks: [callbacks]*const fn (f64, f64, ?*anyopaque) void = undefined,

        resize_userdata: [callbacks]?*anyopaque = undefined,
        key_userdata: [callbacks]?*anyopaque = undefined,
        mouse_userdata: [callbacks]?*anyopaque = undefined,
        cursor_userdata: [callbacks]?*anyopaque = undefined,
